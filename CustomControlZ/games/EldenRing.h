...
enum EldenRingBinding {
    ...
    ER_KEY_DODGE     = 1, // Custom dodge trigger key — EdgeTrigger
    ER_KEY_SPRINT    = 2, // Sprint hold key — HoldToToggle
...
static GameProfile g_EldenRingProfile = {
    ...
    /* bindings */ {
        ...
        // outputVk=0 means HoldToToggle does nothing for this binding; its currentVk
        // is used as the outputVk for SPRINT and DODGE in Phase 1 hardcoded descriptors.

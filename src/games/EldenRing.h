...
enum EldenRingBinding {
    ...
    ER_KEY_TRIGGER   = 1, // Long-press trigger key — LongPress (tap=Escape, hold=Q)
    ER_KEY_DODGE     = 2, // Custom dodge trigger key — EdgeTrigger (app-only)
    ER_KEY_SPRINT    = 3, // Sprint hold key — HoldToToggle (app-only)
    ER_BINDING_COUNT = 4
};
